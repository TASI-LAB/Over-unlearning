...
from tensorflow.keras.layers import Conv2D, Dense, Dropout, MaxPooling2D, Flatten, BatchNormalization, ReLU, Input, Dense, Add, GlobalAveragePooling2D
...
def get_VGG(input_shape=CIFAR_SHAPE, output= 10, weight_path=None, lr_init=0.001, sgd=False):
